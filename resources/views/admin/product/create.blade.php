    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="padding-top: 50px">
            <div class="container" style="padding-left: 50px">
                <h1 style="padding-top: 30px; padding-left: 200px" style=" font-family: Tahoma, Helvetica, Arial">Добавить товар</h1>
                <div class="row">
...
<div class="form-group" style="padding-top: 30px; padding-left: 200px">
    <div class="col-sm-6">
                    <form  action="{{ route('product.store') }}" method="post">
                        ...
                        <p><input class="form-control"  type="text" placeholder="Название" name="title"></p>
                        <p><input class="form-control" type="text" placeholder="Описание" name="description"></p>
                        <p><input class="form-control" type="text" placeholder="Цена" name="price"></p>
